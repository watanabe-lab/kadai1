...
class LoadBarancerForLevel1 < Controller
  ...
  def output_sent_packet(message)
    if message.arp_request?
      ...
      if message.ipv4_saddr.to_s == "192.168.0.25" || message.ipv4_saddr.to_s == "192.168.0.251" || message.ipv4_saddr.to_s == "192.168.0.252" || message.ipv4_saddr.to_s == "192.168.0.253" || message.ipv4_saddr.to_s == "192.168.0.254" 
